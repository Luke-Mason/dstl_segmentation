...
class UFONet(BaseModel):
    def __init__(self, num_classes, **_):
        ...
        self.layers.append(Conv2d(16, 32))
        self.layers.append(Conv2d(32, 32))
        self.layers.append(self.pool)

        self.layers.append(Conv2d(32, 64))
        ...
        self.layers.append(nn.ConvTranspose2d(64, 32, 2, stride=2, padding=0, output_padding=0, bias=True))
        self.layers.append(Conv2d(32, 32))
