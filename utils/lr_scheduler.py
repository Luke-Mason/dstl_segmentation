...
class Poly(_LRScheduler):
    def __init__(self, optimizer, num_epochs, _iters_per_epoch=1,
        ...
        self.iters_per_epoch = _iters_per_epoch
        self.cur_iter = 0
        print('iters_per_epoch', _iters_per_epoch)
        print('num_epochs', num_epochs)

        self.N = num_epochs * self.iters_per_epoch
        self.warmup_iters = warmup_epochs * _iters_per_epoch
...
class OneCycle(_LRScheduler):
    def __init__(self, optimizer, num_epochs, iters_per_epoch=1, last_epoch=-1,
