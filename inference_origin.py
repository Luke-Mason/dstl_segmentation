...
def main():
    ...
    path_model = 'saved/UFONet_wildAnimal_256_batch16_small/07-09_23-51'
    h = 512
    w = 512
    args.model = os.path.join(path_model,'best_model.pth')
    args.images = '/home/kaien125/experiments/data/coco/wildAnimal/images/test'
    args.labels = '/home/kaien125/experiments/data/coco/wildAnimal/annotations/test'
    args.extension = 'jpg'
    ...
    with torch.no_grad():
        ...
        description = str(pixAcc) + ',' + str(mIoU) + ',' + ",".join(class_Iou)
        ...
        if os.path.isfile(logFileLoc):
            ...
            logger.write('Pixel_Accuracy,Mean_IoU,' + ",".join(classNum_list) + '\n')
