...
ID_TO_TRAINID = {-1: ignore_label, 0: ignore_label, 1: ignore_label, 2: ignore_label,
                    3: ignore_label, 4: ignore_label, 5: ignore_label, 6: ignore_label,
                    7: 1, 8: 1, 9: ignore_label, 10: ignore_label, 11: 2, 12: 2, 13: 2,
                    14: ignore_label, 15: ignore_label, 16: ignore_label, 17: 3,
                    18: ignore_label, 19: 3, 20: 3, 21: 4, 22: 4, 23: 5, 24: 6, 25: 6, 26: 7, 27: 7,
                    28: 7, 29: ignore_label, 30: ignore_label, 31: 7, 32: 7, 33: 7}
...
class CityScapesDataset(BaseDataSet):
    ...
    def _set_files(self):
        ...
        if self.mode == 'coarse':
            ...
            img_dir_name = 'cityscapes'
            label_path = os.path.join(self.root, 'cityscapes', 'gtFine', self.split)
